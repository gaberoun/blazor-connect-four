...
public class GameState
{
    ...
    // returns: 0 - no winner, 1 - player 1 wins, 2 - player 2 wins, 3 - draw
    ...
    // param: 0-indexed column to place the piece into
    // returns: The final array index where the piece resides
